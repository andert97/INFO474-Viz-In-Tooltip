...
function makeLabels(svgContainer, msm, title, x, y) {
    ...
    svgContainer.append('text')
        .attr('x', msm.marginLeft + (msm.width - 2 * msm.marginAll) / 2 - 30)
...
function drawAxes(limits, x, y, svgContainer, msm) {
    ...
    let xScale = d3.scaleLinear()
        ...
        .range([0 + msm.marginAll + msm.marginLeft, msm.width - msm.marginAll])
    ...
    let yScale = d3.scaleLinear()
        ...
        .range([0 + msm.marginAll + msm.marginLeft, msm.height - msm.marginAll ])
    ...
    svgContainer.append('g')
        .attr('transform', 'translate(' + (msm.marginAll + msm.marginLeft) + ', 0)')
        .call(yAxis);
